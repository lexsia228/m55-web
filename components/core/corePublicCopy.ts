...
export const STATIC_M55_READ_STEPS: readonly {
  ...
  },
  {
    ...
    body: 'ここで見えてきた輪郭は、Entry Report や相談返書で、いまの悩みや迷いを整理していく土台になります。',
  },
];

export const STATIC_AI_EXPLAINER = {
  title: 'この輪郭を土台に、相談を深掘りできます',
  lead: [
    'M55の返書は、その場の入力だけを広げる一般的な会話ではありません。',
    '先に見えている tさん固有の傾向を土台にして、いまの悩みをどこから読むべきかを整理します。',
    'そのため、同じ「仕事がしんどい」「人間関係で迷っている」という相談でも、返ってくる整理は人によって変わります。見えている出方が違うからです。',
  ] as const,
  items: [
    {
...
export const STATIC_CTA = {
  title: 'Entry Report',
  linkLabel: 'Entry Report の詳細を見る',
  lines: [
    '1000円で受け取れる、tさん専用の有料レポートです。',
    'ここまでの core では、入力情報をもとに読み出した傾向の輪郭と、負荷がかかりやすい場面までを見ています。Entry Report では、その輪郭が生活の中でどう重なって出やすいかを、章立てで読み返せる形に整理して受け取れます。',
    '含まれるのは、たとえば次のような内容です。',
    '・5つの軸が tさんの中でどう重なって出やすいか',
    '・仕事・対人・疲れやすさ・判断の癖としてどう表れやすいか',
    '・どこから整えると戻りやすいか',
    '・この個別解析を土台にした相談返書',
    'ここで受け取るのは、汎用的な説明ではなく、入力後に立ち上がった tさん固有の読みの深掘りです。',
