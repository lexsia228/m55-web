...
export const STATIC_M55_READ_STEPS: readonly {
  ...
  {
    title: 'ふだん出やすい傾向を見る',
    body: '人との距離感、感受性、発想、協調、段取りの5つから、基本の輪郭を見ます。',
  },
  {
...
export const STATIC_AI_EXPLAINER = {
  title: '相談返書の読み方',
  lead: [
    'M55の相談返書は、なんでも答えるAIではありません。',
    '保存版に今回入力した一つの相談テーマを重ね、いま気になっている論点を読み直します。',
    '同じ悩みでも、見えている輪郭が違えば、返ってくる整理も変わります。',
  ] as const,
  items: [
    {
      title: '保存版の傾向を土台に整理する',
      body: 'その場の言葉だけでなく、すでに読み出されている輪郭を前提にします。',
    },
    {
      title: '入力をそのまま広げない',
      body: '書かれた悩みを増幅するのではなく、今の論点を必要な形に絞ります。',
    },
    {
