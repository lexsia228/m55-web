...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED confirmed** — **`5Z-I-V-AJ-R`**；plan **`5Z-I-V-AK`** | **5Z-I-V-AK** |
...
| **CONTROL-46** | Production Clerk auth compliance correction planning | **open** — **`5Z-I-V-AK`** Category 2 plan only |
...
| **Update after** | **`5Z-I-V-AJ-R`** Production auth compliance dashboard replay RED |
