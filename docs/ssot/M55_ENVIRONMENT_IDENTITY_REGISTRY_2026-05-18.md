...
| **W-72** | **Release readiness guardrails** | **consolidated** — **`5Z-I-V-AS-D`** | **AS-B1-R** or **AS-C4** |
| **W-75** | **Release readiness master checklist** | **active** — **§2aI** | **AS-B1-R** or **AS-C4** |
| **W-74** | **AI prompt safety guard** | **static review GREEN** — **`5Z-I-V-AS-C3`**；selfcheck 10/10 | **AS-C4** or **AS-B1-R** |
...
| **Update after** | **`5Z-I-V-AS-C3`** static/local AI safety review |
