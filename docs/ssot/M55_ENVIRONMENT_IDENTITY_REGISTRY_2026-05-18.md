...
| **W-72** | **Release readiness guardrails** | **consolidated** — **`5Z-I-V-AS-D`** | **AS-C5** or **AS-B1-R** |
| **W-75** | **Release readiness master checklist** | **active** — **§2aI** | **AS-C5** or **AS-B1-R** |
| **W-74** | **AI prompt safety guard** | **C4-R GREEN** — local/static + terms disclaimer；deploy pending | **AS-C5** or **AS-B1-R** |
...
| **CONTROL-92** | AS-C5 output-side sanitizer planning | **open** |
...
| **Update after** | **`5Z-I-V-AS-C4-R`** production-safe AI safety verification result |
