...
| **W-72** | **Release readiness guardrails** | **consolidated** — **`5Z-I-V-AS-D`** | **AS-B1** or **AS-C1** |
| **W-75** | **Release readiness master checklist** | **active** — **§2aI** | **AS-B1** default |
| **W-74** | **AI prompt safety guard** | **planned** — **`5Z-I-V-AS-C`** GREEN | **AS-C1** or **AS-D** |
| **W-73** | **Minimal error notification** | **planned** — **`5Z-I-V-AS-B`**；interim manual polling | **AS-B1** or **AS-B2** |
...
| **CONTROL-84** | Manual failed_fulfillments polling execution | **open** — **`5Z-I-V-AS-B1`** |
...
| **CONTROL-88** | AS-B1 manual polling runbook | **open** — priority **1** |
...
| **Update after** | **`5Z-I-V-AS-D`** release readiness checklist consolidation |
