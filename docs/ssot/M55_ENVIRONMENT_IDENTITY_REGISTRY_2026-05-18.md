...
| **W-72** | **Release readiness guardrails** | **triaged** — **`5Z-I-V-AS-A`** | **`5Z-I-V-AS-B`** then **AS-C** |
...
| **CONTROL-82** | Minimal error notification planning | **open** — **`5Z-I-V-AS-B`** |
...
| **Update after** | **`5Z-I-V-AS-A`** release readiness immediate guardrail triage |
