...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — **AW-R** SQL draft GREEN | **5Z-I-V-AX-PRE** or **AS** |
| **W-55** | **Namespace continuity inventory** | **resolved negative** — SQL draft reviewed | **5Z-I-V-AX-PRE** |
...
| **W-64** | **Identity mappings SQL draft reviewed** | **yes** — **`5Z-I-V-AW-R`** GREEN | **5Z-I-V-AX-PRE** |
...
| **CONTROL-73** | Identity mappings migration file creation / dry-run planning | **open** — **`5Z-I-V-AX-PRE`** |
| **CONTROL-66** | Mapping migration execution | **open** — **`5Z-I-V-AX`**（after **AX-PRE** + Human GO） |
...
| **Update after** | **`5Z-I-V-AW-R`** identity mappings migration SQL draft review |
