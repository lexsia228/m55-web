...
| **W-72** | **Release readiness guardrails** | **triaged** — **AS-C planned** | **`5Z-I-V-AS-D`** |
...
| **CONTROL-87** | Release readiness checklist consolidation | **open** — **`5Z-I-V-AS-D`** |
...
| **Update after** | **`5Z-I-V-AS-C`** AI prompt safety guard planning |
