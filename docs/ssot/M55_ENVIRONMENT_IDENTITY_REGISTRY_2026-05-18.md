...
| **W-74** | **AI prompt safety guard** | **C6-D deploy FAILED** — build `.js` imports | **AS-C6-D-R** |
...
| **CONTROL-108** | AS-C6-D-R deploy failure / import fix + redeploy | **open** |
...
| **Update after** | **`5Z-I-V-AS-C6-D`** prompt safety deploy execution（failed） |
