...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — **AR-R RED**（separate namespace） | **5Z-I-V-AT** or **AS** |
| **W-55** | **Namespace continuity inventory** | **resolved negative** — **AR-R RED** `separate` | **5Z-I-V-AT** |
| **W-56** | **Clerk Development user population** | **5 total / 5 active** — **`5Z-I-V-AP-R`** | **AT** |
| **W-57** | **Supabase paid-artifact aggregates** | **recorded `5Z-I-V-AP-S-R`** — ent **10**；rights **7**；snap **6**；wallets **10**；OTF **10/7** | **AT** |
| **W-58** | **Production instance creation authorized** | **no** — **AR-R RED** | **AT** then chain |
| **W-59** | **Development → Production user_id continuity confirmed** | **no** — **`separate`**（**AR-R**） | **5Z-I-V-AT** |
...
| **CONTROL-61** | User mapping / entitlement preservation planning | **open** — **`5Z-I-V-AT`**（**required** if compliance pursued） |
...
| **Update after** | **`5Z-I-V-AR-R`** Clerk user_id continuity replay result |
