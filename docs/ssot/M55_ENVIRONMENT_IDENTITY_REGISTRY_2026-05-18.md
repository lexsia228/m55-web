...
| **W-72** | **Release readiness guardrails** | **consolidated** — **`5Z-I-V-AS-D`** | **AS-B1-R** or **AS-C1** |
| **W-75** | **Release readiness master checklist** | **active** — **§2aI** | **AS-B1-R** or **AS-C1** |
| **W-74** | **AI prompt safety guard** | **planned** — **`5Z-I-V-AS-C`** GREEN | **AS-C1** or **AS-D** |
...
| **CONTROL-86** | AI prompt safety implementation | **open** — **`5Z-I-V-AS-C1`** onward |
...
| **CONTROL-89** | AS-C1 prompt safety impl planning | **open** — priority **2** |
...
| **Update after** | **`5Z-I-V-AS-B1`** manual failed_fulfillments polling runbook planning |
