...
| **Production apply** | **no** |
| **AL authorized** | **no** |
| **next** | **`5Z-I-V-AX-PROD`** or **`5Z-I-V-AS`** |
...
| **AL authorized** | **no** |
| **next** | **`5Z-I-V-AX-PROD`**（explicit Human GO + backup）or **`5Z-I-V-AS`** |
...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — **AX-PROD-PRE** planned；apply **not authorized** | **`5Z-I-V-AX-PROD`** or **AS** |
| **W-55** | **Namespace continuity inventory** | **resolved negative** — Production apply plan ready | **`5Z-I-V-AX-PROD`** |
...
| **W-66** | **Identity mappings migration file in repo** | **yes** — shadow applied；Production **not applied** | **`5Z-I-V-AX-PROD`** |
| **W-67** | **Identity mappings non-Prod dry-run** | **GREEN** — **R2** | **`5Z-I-V-AX-PROD`** |
| **W-68** | **Identity mappings shadow apply + verify** | **closed** — **R2 GREEN** | **`5Z-I-V-AX-PROD`** |
| **W-69** | **Identity mappings Production apply plan** | **GREEN** — **`5Z-I-V-AX-PROD-PRE`** | **`5Z-I-V-AX-PROD`** |
...
| **CONTROL-76** | Identity mappings Production migration apply | **open** — **`5Z-I-V-AX-PROD`**；requires explicit Human GO + backup |
...
| **Update after** | **`5Z-I-V-AX-PROD-PRE`** identity mappings Production backup / apply planning |
