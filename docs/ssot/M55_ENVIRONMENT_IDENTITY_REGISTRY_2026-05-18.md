...
| **AL authorized** | **no** |
| **next** | **`5Z-I-V-AR-replay`** or **`5Z-I-V-AS`** |
...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — AR plan GREEN；await **AR-replay** | **5Z-I-V-AR-replay** or **AS** |
| **W-55** | **Namespace continuity inventory** | **partial** — AR confirmation plan GREEN；continuity **`not_confirmed`** | **5Z-I-V-AR-replay** |
| **W-56** | **Clerk Development user population** | **5 total / 5 active** — **`5Z-I-V-AP-R`** | **AR-replay** |
| **W-57** | **Supabase paid-artifact aggregates** | **recorded `5Z-I-V-AP-S-R`** — ent **10**；rights **7**；snap **6**；wallets **10**；OTF **10/7** | **AR-replay/AT** |
| **W-58** | **Production instance creation authorized** | **no** — **`5Z-I-V-AR`** | **AR-replay** then chain |
| **W-59** | **Development → Production user_id continuity confirmed** | **not_confirmed** — await **AR-replay** | **5Z-I-V-AR-replay** |
...
| **CONTROL-62** | Clerk `user_id` continuity AR-replay submission | **open** — **`5Z-I-V-AR-replay`** |
| **CONTROL-60** | Temporary auth compliance exception governance | **open** — **`5Z-I-V-AS`**（optional） |
| **CONTROL-61** | User mapping / entitlement preservation planning | **open** — **`5Z-I-V-AT`**（if AR = no） |
...
| **Update after** | **`5Z-I-V-AR`** Clerk user_id continuity confirmation planning |
