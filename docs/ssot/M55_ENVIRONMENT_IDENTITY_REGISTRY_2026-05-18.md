...
| **auth compliance** | **BLOCKED**（not GREEN） |
| **fresh Human dashboard** | **no** in AJ session |
| **dual-app conflict** | **unresolved** |
| **next** | **AJ-replay**（prefix class only） |
...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **open** — **AJ BLOCKED**；**replay pending** | **AJ-replay** |
| **W-51** | **Auth compliance dashboard confirmation** | **BLOCKED** — **`5Z-I-V-AJ`** no fresh Human dashboard | **AJ-replay** |
...
| **CONTROL-19** | Production auth compliance remains unresolved | **open** — **AJ BLOCKED**；**AJ-replay** |
| **CONTROL-44** | Production auth compliance dashboard read-only confirmation | **BLOCKED** — **`5Z-I-V-AJ`**；**AJ-replay** required |
| **CONTROL-45** | Production auth compliance Human dashboard replay | **open** — prefix class only |
...
| **Update after** | **`5Z-I-V-AJ`** Production auth compliance dashboard confirmation |
