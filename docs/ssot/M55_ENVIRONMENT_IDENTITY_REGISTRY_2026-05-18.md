...
| **Production apply** | **no** |
| **AL authorized** | **no** |
| **next** | **`5Z-I-V-AX-DRYRUN-R`**（completed BLOCKED）→ **Human shadow replay + counts evidence** |
...
| **AL authorized** | **no** |
| **next** | Human **`m55-soul-shadow`** apply + counts-only verification |
...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — **AX-DRYRUN-R BLOCKED** | **shadow replay** or **AS** |
| **W-55** | **Namespace continuity inventory** | **resolved negative** — dry-run replay blocked | **shadow replay** |
...
| **W-66** | **Identity mappings migration file in repo** | **yes** — **`5Z-I-V-AX-FILE`**；**not applied** | **AX-DRYRUN-R** |
| **W-67** | **Identity mappings non-Prod dry-run** | **BLOCKED** — AX-DRYRUN + AX-DRYRUN-R；await shadow apply | **Human shadow replay** |
| **W-68** | **Identity mappings shadow apply + verify** | **open** — needs confirmed **`m55-soul-shadow`** | **counts-only replay** |
...
| **CONTROL-75** | Identity mappings migration dry-run | **BLOCKED** — **`5Z-I-V-AX-DRYRUN`**；await **`5Z-I-V-AX-DRYRUN-R`** |
| **CONTROL-77** | Identity mappings dry-run Human replay | **BLOCKED** — **`5Z-I-V-AX-DRYRUN-R`**；no confirmed target |
| **CONTROL-78** | Identity mappings shadow apply + counts verify | **open** — Human **`m55-soul-shadow`** only |
...
| **Update after** | **`5Z-I-V-AX-DRYRUN-R`** identity mappings dry-run Human replay |
