...
| **W-46** | **Type-label mismatch separate** | **TL-A plan GREEN** — **TL-A-R** | **TL-A-R** |
...
| **CONTROL-08** | DTR type label SSOT alignment plan | **active** — **`5Z-I-V-TL-A`** plan GREEN；**TL-A-R** next |
| **CONTROL-112** | TL-A-R type-label read-only diagnostic result | **open** |
...
| **Update after** | **`5Z-I-V-TL-A`** type-label mismatch diagnostic planning |
