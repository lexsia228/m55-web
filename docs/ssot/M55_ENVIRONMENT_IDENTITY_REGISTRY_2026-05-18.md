...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — **AW** migration plan GREEN | **5Z-I-V-AW-R** or **AS** |
| **W-55** | **Namespace continuity inventory** | **resolved negative** — **AW** DDL plan GREEN | **5Z-I-V-AW-R** |
...
| **W-63** | **Identity mappings DB migration planned** | **yes** — **`5Z-I-V-AW`** GREEN | **5Z-I-V-AW-R** |
...
| **CONTROL-72** | Identity mappings migration SQL draft review | **open** — **`5Z-I-V-AW-R`** |
| **CONTROL-66** | Mapping migration execution | **open** — **`5Z-I-V-AX`**（after **AW-R**） |
...
| **Update after** | **`5Z-I-V-AW`** m55_user_identity_mappings DB migration planning |
