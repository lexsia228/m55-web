...
| **W-44** | **Production auth compliance unresolved after DTR unlock** | **RED** — inventory **AP BLOCKED** | **AP-replay** |
| **W-55** | **Namespace continuity inventory** | **BLOCKED** — fresh counts missing | **AP-replay** |
...
| **CONTROL-55** | Production Clerk namespace inventory replay | **open** — counts only |
...
| **Update after** | **`5Z-I-V-AP`** Namespace continuity read-only inventory |
