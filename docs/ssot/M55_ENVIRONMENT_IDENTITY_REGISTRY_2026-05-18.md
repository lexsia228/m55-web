...
| **W-74** | **AI prompt safety guard** | **C5-C static GREEN** — deploy AS-C6 | **AS-C6** |
...
| **CONTROL-106** | AS-C6 prompt safety deploy planning | **open** — Human GO for execution |
...
| **Update after** | **`5Z-I-V-AS-C5-C`** output-side sanitizer static/local review |
