...
| **W-74** | **AI prompt safety guard** | **C5-B repo GREEN** — deploy AS-C6 | **AS-C5-C** or **C6** |
...
| **CONTROL-105** | AS-C5-C output sanitizer static/local review | **open** |
...
| **Update after** | **`5Z-I-V-AS-C5-B`** output-side sanitizer implementation execution |
