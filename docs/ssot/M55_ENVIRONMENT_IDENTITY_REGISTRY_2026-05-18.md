...
| **W-55** | **Namespace continuity inventory** | **BLOCKED** — Clerk **5/5**；Supabase **unclear** | **5Z-I-V-AP-S** |
...
| **CONTROL-57** | Supabase aggregate inventory replay | **open** — **`5Z-I-V-AP-S`** |
...
| **Update after** | **`5Z-I-V-AP-R`** Namespace continuity AP-replay counts |
