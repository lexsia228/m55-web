...
CREATOR_AFFILIATE_TERMS_CANONICAL_ROUTE = /legal/creator-affiliate-terms
CREATOR_AFFILIATE_TERMS_VERSION = 2026-09-13-v1
CREATOR_AFFILIATE_TERMS_MATERIAL_CHANGE_REACCEPTANCE = REQUIRED_FOR_FUTURE_EARNINGS
CREATOR_AFFILIATE_TERMS_HISTORICAL_REPRICING = PROHIBITED
```
