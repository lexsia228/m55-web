...
| **G4 ORGANIC DISCOVERY** | **CLOSED GREEN** — WT-046 / `feat/m55-g4-organic-discovery-v1` @ `77a9a7e86aee33f7f3c1af79927ea4c9840d4450` · Wave 1+2 authority/indexability + qualified landing identity · canonical entry `/home` · `/pricing` retired → `/dtr/lp` · JSON-LD deferred | **DO NOT REOPEN** absent actual invalidation |
