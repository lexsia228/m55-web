        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            <p style={{ margin: "0 0 4px" }}>
              <strong>M55 プレミアムレポート ライト</strong> — まずプレミアムレポートを読み、輪郭を整理したい方向け
            </p>
            <ul style={{ margin: 0, paddingLeft: 18 }}>
              <li>販売価格：¥1,000（税込）</li>
              <li>内容：4章のプレミアムレポート</li>
              <li>追加読み解き：1件</li>
            </ul>
          </div>
          ...
          <div>
            <p style={{ margin: "0 0 4px" }}>
              <strong>M55 プレミアムレポート フル</strong> — プレミアムレポートを読んだあと、追加読み解きで複数回深めたい方向け
            </p>
            <ul style={{ margin: 0, paddingLeft: 18 }}>
              <li>販売価格：¥1,480（税込）</li>
              <li>内容：4章のプレミアムレポート</li>
          ...
          <div>
            ...
            <ul style={{ margin: 0, paddingLeft: 18 }}>
              <li>販売価格：¥600（税込）</li>
              <li>対象：M55 プレミアムレポート ライトを購入済みの方</li>
