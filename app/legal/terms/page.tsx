    ...
    <main style={{
      ...
      <section style={{ margin: "0 0 16px" }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          ...
          <li>プレミアムレポートは、購入時点の入力内容をもとにした読み返し用レポートです。</li>
      ...
      <section style={{ margin: "0 0 16px" }}>
        ...
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          <li>追加読み解きは、プレミアムレポートを購入したユーザーのみ利用できます。</li>
          <li>追加読み解きは、プレミアムレポートに紐づく一つの読み解きテーマを整理する追加読み解きです。件数内での利用であり、会話を継続する形式ではありません。</li>
          <li>M55 プレミアムレポート ライト（¥1,000）には追加読み解き1件が含まれます。まずプレミアムレポートを読みたい方向けです。</li>
          <li>M55 プレミアムレポート フル（¥1,480）には追加読み解きが合計5件含まれます。追加読み解きで複数回深めたい方向けです。</li>
          ...
          <li>追加読み解きは当該プレミアムレポートに付随するサービスであり、一般公開された会話サービスではありません。</li>
        </ul>
      </section>
      ...
      <section style={{ margin: "0 0 16px" }}>
        ...
        <p style={{ margin: 0 }}>
          ...
          将来や関係性を断定するサービスではなく、医療・法律・投資等の専門的助言ではありません。
        </p>
      </section>
