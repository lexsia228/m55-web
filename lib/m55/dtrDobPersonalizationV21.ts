...
// ── S5: 摩擦・詰まり（exact solarTerm × dayBand） ────────────────────────────

const S5_SOLAR_TERM_FRICTION: readonly string[] = [
  '寒さが深い頃の生まれとして、急いで動くほど負荷が重なりやすい形です。',                     // xiaohan 0
  '冬の底に近い生まれとして、無理を重ねる前に手元を温めるほど摩擦が減りやすくなります。',       // dahan 1
  '春の始まりに近い生まれとして、始めすぎる前に区切りを置くほど詰まりにくくなります。',         // lichun 2
  '解けはじめる頃の生まれとして、一度に広げるより段階を分けるほど摩擦が軽くなります。',         // yushui 3
  '目覚めの季節に近い生まれとして、動き出しを急ぐほど無理がたまりやすい形です。',               // jingzhe 4
  '春分に近い生まれとして、左右のバランスが崩れると負荷が出やすい形です。',                     // chunfen 5
  '清らかに進む頃の生まれとして、抱え込みすぎるほど摩擦が重なりやすくなります。',               // qingming 6
  '準備が実る頃の生まれとして、段取りを飛ばすほど詰まりやすい形です。',                         // guyu 7
  '動きが出る頃の生まれとして、休息を後回しにするほど無理がたまりやすくなります。',             // lixia 8
  '充実感が出る頃の生まれとして、一度に抱える量を増やすほど摩擦が重なりやすい形です。',         // xiaoman 9
  '動きながら仕上げる頃の生まれとして、完了前に次を始めるほど詰まりやすくなります。',           // mangzhong 10
  '勢いが強い頃の生まれとして、熱量を一点に絞りすぎるほど反動が出やすい形です。',               // xiazhi 11
  '熱が出やすい頃の生まれとして、ペースを守らないほど消耗が重なりやすくなります。',             // xiaoshu 12
  '最も熱量が強い頃の生まれとして、休む区切りを省くほど摩擦がたまりやすい形です。',             // dashu 13
  '見直しの頃の生まれとして、残す量を決めずに進むほど詰まりやすくなります。',                   // liqiu 14
  '熱が落ち着く頃の生まれとして、切り替えを急ぐほど無理が重なりやすい形です。',                 // chushu 15
  '精緻に整える頃の生まれとして、細部に入りすぎるほど負荷がたまりやすくなります。',             // bailu 16
  '秋分に近い生まれとして、決めきれないまま進むほど摩擦が重なりやすい形です。',                 // qiufen 17
  '深みが出る頃の生まれとして、抱え込みながら進むほど詰まりやすくなります。',                   // hanlu 18
  '寒さが増す前の頃の生まれとして、手元を整えずに動くほど無理が出やすい形です。',               // shuangjiang 19
  '冬の入り口の頃の生まれとして、内側を空にしたまま進むほど摩擦が重なりやすくなります。',       // lidong 20
  '静かに深める頃の生まれとして、動きを絞りすぎるほど詰まりやすい形です。',                     // xiaoxue 21
  '寒さが深まる時期の生まれとして、範囲を広げすぎるほど負荷がたまりやすくなります。',           // daxue 22
  '折り返しに近い時期の生まれとして、整えずに次へ進むほど無理が重なりやすい形です。',           // dongzhi 23
] as const;

const S5_DAYBAND_FRICTION: readonly [string, string, string, string, string] = [
  '月の初めに近いリズムとして、始める量を一度に増やすほど摩擦が出やすくなります。',
  '月の序盤に近いリズムとして、試す範囲を広げすぎるほど詰まりやすくなります。',
  '月の中頃のリズムとして、区切りを置かずに続けるほど負荷が重なりやすくなります。',
  '月の後半に近いリズムとして、終える前に次を始めるほど無理がたまりやすくなります。',
  '月末に近いリズムとして、整理前に抱え込むほど摩擦が重なりやすくなります。',
];

// ── S6: 関係・距離（lunarMonth × dayBand） ────────────────────────────────────

const S6_LUNAR_MONTH_RELATION: readonly string[] = [
  '年始に近い時期の生まれとして、距離を急に詰めすぎるほどやりとりが重くなりやすい形です。',
  '寒暖が変わりやすい時期の生まれとして、相手の反応を急いで読み取ろうとするほど疲れやすくなります。',
  '動きが戻る時期の生まれとして、小さく確かめながら距離を取るほど関係が整いやすくなります。',
  '流れが整いやすい時期の生まれとして、言葉を一度に多く出すほどすれ違いが起きやすい形です。',
  '熱が上がる前の時期の生まれとして、休息を挟まずに関わるほど距離感が崩れやすくなります。',
  '勢いが出やすい時期の生まれとして、早く答えを出そうとするほどやりとりが硬くなりやすい形です。',
  '集中が出やすい時期の生まれとして、切り替えを急ぐほど相手との距離が詰まりやすくなります。',
  '後半に向かう時期の生まれとして、抱え込みながら関わるほど会話が重くなりやすい形です。',
  '区切りへ向かう時期の生まれとして、一度立ち止まって距離を確かめるほど関係が戻りやすくなります。',
  '落ち着きが出る時期の生まれとして、急いで距離を詰めるほどやりとりが疲れやすくなります。',
  '手元を整える時期の生まれとして、新しい関わりを一度に増やすほど距離感が崩れやすい形です。',
  '折り返しに近い時期の生まれとして、終えた関係を整理してから次へ進むほど会話が整いやすくなります。',
] as const;

const S6_DAYBAND_RELATION: readonly [string, string, string, string, string] = [
  '月の初めに近いリズムとして、最初の一言を急ぐほど距離が詰まりすぎやすくなります。',
  '月の序盤に近いリズムとして、試す量を絞ってから関わるほどやりとりが軽くなります。',
  '月の中頃のリズムとして、短く区切って返すほど会話のリズムが整いやすくなります。',
  '月の後半に近いリズムとして、終える話題を先に決めるほど関係が扱いやすくなります。',
  '月末に近いリズムとして、整理してから次のやりとりへ移るほど距離が保ちやすくなります。',
];
...
export function buildPaidDtrIndividualizationV21FromEngineContext(
  ...
  // S5: solarTerm friction + dayBand friction
  const s5FrictionRhythmNote = [
    S5_SOLAR_TERM_FRICTION[stIdx]!,
    S5_DAYBAND_FRICTION[band],
  ].join('\n');

  // S6: lunarMonth relation + dayBand relation pace
  const s6RelationRhythmNote = [
    S6_LUNAR_MONTH_RELATION[mIdx]!,
    S6_DAYBAND_RELATION[band],
  ].join('\n');
