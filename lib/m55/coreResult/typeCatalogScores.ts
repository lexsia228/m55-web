import type { AxisKey, CoreResult } from './types';

export type TypeScoreSeed = {
  coreType: string;
  coreSummary: string;
...
/** Score/copy seeds without internal trait labels — safe for /core client seal path. */
export const TYPE_SCORE_SEEDS: readonly TypeScoreSeed[] = [
  {
    coreType: 'TYPE_01',
    coreSummary:
