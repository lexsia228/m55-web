...
export const TYPE_CATALOG: readonly TypeCatalogSeed[] = [
  {
    ...
    workStyle: {
      summary:
        '裁量があり、静かに深掘りできる仕事で力を発揮しやすい観測です。雑音の少ない環境ほど輪郭がはっきりします。',
      strengths: [
        '課題の前提を洗い出しやすい',
        'ドキュメントや基準を整えやすい',
        '品質のばらつきを抑えやすい',
  ...
  },
  {
    ...
    workStyle: {
      summary:
        '人と協働する仕事、合意形成の場で力を出しやすい観測です。一人完結よりチームの潤滑油として効きやすいです。',
      strengths: ['利害の橋渡しがしやすい', '関係者の温度を揃えやすい', '雰囲気を壊さずに提案しやすい'],
      cautions: ['評価が見えにくい役割に偏りやすい', '断りにくい依頼を抱えやすい'],
    },
    relationships: {
  ...
  },
  {
    ...
    workStyle: {
      summary:
        '設計・分析・運用設計など、頭を使って形にする仕事で伸びやすい観測です。',
      strengths: ['要件を構造化しやすい', 'リスクを先に洗い出しやすい', 'ドキュメントで共有しやすい'],
  ...
  },
  {
    ...
    workStyle: {
      summary: '分析・監査・改善など、観測と検証が中心の役割で力を発揮しやすいです。',
      strengths: ['仮説を検証しやすい', '再発防止の線を引きやすい', '冷静なレポートが書きやすい'],
      cautions: ['スピード重視の場で窮屈に感じやすい', '雑な合意に違和感を抱えやすい'],
    },
    relationships: {
  ...
  },
  {
    ...
    workStyle: {
      summary:
        'プロジェクト調整・ステークホルダー対応など、人と進行の両方が絡む役割で伸びやすいです。',
      strengths: ['優先順位のすり合わせがしやすい', '会議を前に進めやすい', '空気を壊さずに論点化しやすい'],
      cautions: ['決裁が遅れると窮屈に感じやすい', '評価が見えにくい'],
    },
    relationships: {
  ...
  },
  {
    ...
    workStyle: {
      summary:
        '立ち上げ・企画・ファシリテーションなど、前に出る役割で力を発揮しやすい観測です。',
      strengths: ['アイデアを言語化しやすい', 'チームの温度を上げやすい', '初速を出しやすい'],
      cautions: ['運用フェーズで飽きやすい', '細かい手続きに負荷が出やすい'],
    },
    relationships: {
  ...
  },
  {
    ...
    workStyle: {
      summary:
        '裁量があり、深く考えて組み立てられる仕事で力を発揮しやすい観測です。',
      strengths: ['課題の本質を掘れる', '曖昧な情報を整理できる', '独自の視点を提案しやすい'],
  ...
  },
  {
    ...
    workStyle: {
      summary:
        'PM・オペレーション・実行責任者など、進行を握る役割で力を出しやすいです。',
      strengths: ['タスクを分解しやすい', 'ボトルネックを特定しやすい', '意思決定を促しやすい'],
      cautions: ['人間関係のケアが後回しになりやすい', '評価が厳しめに伝わりやすい'],
    },
    relationships: {
  ...
  },
  {
    ...
    workStyle: {
      summary:
        '人事・CS・営業同行など、人の感情が絡む役割で力を発揮しやすい観測です。',
      strengths: ['相手の不安を言語化しやすい', '信頼残高を積み上げやすい', '対立を小さく収束しやすい'],
      cautions: ['感情労働が積み上がりやすい', '評価指標が見えにくい'],
    },
    relationships: {
  ...
  },
  {
    ...
    workStyle: {
      summary:
        'プロダクトオーナー・事業企画など、横断する役割で力を発揮しやすい観測です。',
      strengths: ['ロードマップを描きやすい', '利害を一つの目標に寄せやすい', '説得力ある資料を作りやすい'],
      cautions: ['現場の泥臭さに負荷が出やすい', '決裁の遅れに苛立ちやすい'],
    },
    relationships: {
