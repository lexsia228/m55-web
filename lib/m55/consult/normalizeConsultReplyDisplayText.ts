...
const TODAY_STEP_DISPLAY_REPAIRS: [string, string][] = [
  ...
  ['最後に、プレミアムレポートの内容を再度読み返し、どのように自分の進め方を整えるかを考えてみてください。', ''],
  ['最後に、プレミアムレポートの内容を再度読み返し、', ''],
  ['プレミアムレポートの内容を再度読み返し、どのように自分の進め方を整えるかを考えてみてください。', ''],
  ['プレミアムレポートの内容を再度読み返し、', ''],
  ['どのように自分の進め方を整えるかを考えてみてください。', ''],
  ['プレミアムレポートの章を読み返し、どのように自分の進め方を整えるかを考えてみてください。', ''],
  ['プレミアムレポートの章を読み返す問いを1文入れる', ''],
  // Legacy stored replies (pre–premium terminology)
...
const TODAY_STEP_STRIP_PATTERNS: RegExp[] = [
  /最後に、プレミアムレポート(?:の内容|の章)?を(?:再度)?読み返し[^。]*。/g,
  /プレミアムレポート(?:の内容|の章)?を(?:再度)?読み返し[^。]*。/g,
