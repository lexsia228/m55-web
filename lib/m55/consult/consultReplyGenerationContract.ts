...
- 最終文は必ず「。」で終える。「…」「...」で終わらせない。
- 5段落目（今日の一手）は必ず「今日やることは1つだけです。」で始め、行動は1つだけ。例文は1つまで。本文に「プレミアムレポートを読み返す」「プレミアムレポートの内容を再度読み返し」を入れない。` as const;
...
【プレミアムレポート接続 — 2段落目】
- 資質名や章タイトルを並べるだけにしない。相談の迷い（例: やめたいのに止められない、区切りが置けない、終えるタイミングが見えない）に、プレミアムレポートの傾向語を1〜2文で直接接続する。
