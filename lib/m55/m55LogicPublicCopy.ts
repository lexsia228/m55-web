...
export const M55_LOGIC_HOME_COPY = {
  titleJa: 'M55とは',
  bodyParagraphsJa: [
    'M55は、生年月日を10資質レーンへ分けるだけではありません。旧暦月・季節位置・日帯などの暦信号を重ねて、自分の動き方・疲れ方・戻し方まで見えるプレミアムレポートに整えます。',
    `無料では、生年月日を入口に、10資質レーンと${M55_LOGIC_FIVE_AXES_JA}の5つの視点で、いま出やすい輪郭を短く確認できます。`,
    'プレミアムレポートでは、同じ根拠をプレミアムレポートで深く読み返せます。本文は固定ルールで組み立てられ、同じ生年月日なら同じ読み方に戻れます。',
    '追加読み解きは別のレイヤーです。プレミアムレポートに沿って、いまの1テーマだけ整理する追加読み解きです。会話を続ける形式ではありません。',
...
export const M55_LOGIC_CORE_COPY = {
  ...
  bodyParagraphsJa: [
    ...
    'プレミアムレポートでは、同じ根拠をプレミアムレポートで深く読み返せます。追加読み解きは、プレミアムレポートに沿って1テーマを整理します。',
  ] as const,
} as const;
