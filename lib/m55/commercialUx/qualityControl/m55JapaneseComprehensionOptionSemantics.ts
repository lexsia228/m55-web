...
export const M55_RELATION_STAGE_OPTION_SEMANTICS = [
  { optionCopyId: 'pair.relation_stage.R1', semanticAxis: 'relationship_state', semanticValue: 'relation_stage.R1' },
  { optionCopyId: 'pair.relation_stage.R2', semanticAxis: 'current_interaction_state', semanticValue: 'relation_stage.R2' },
  { optionCopyId: 'pair.relation_stage.R3', semanticAxis: 'relationship_state', semanticValue: 'relation_stage.R3' },
  { optionCopyId: 'pair.relation_stage.R4', semanticAxis: 'relationship_state', semanticValue: 'relation_stage.R4' },
  { optionCopyId: 'pair.relation_stage.R5', semanticAxis: 'personal_intention', semanticValue: 'relation_stage.R5' },
  { optionCopyId: 'pair.relation_stage.R6', semanticAxis: 'future_orientation', semanticValue: 'relation_stage.R6' },
] as const;
