...
export const PAID_QUESTIONNAIRE_COPY_V1: readonly PaidQuestionCopy[] = [
  ...
  },
  {
    ...
    shortLabelJa: '戻り方',
    questionJa: '負担がたまったあと、最初に整えやすいのはどれですか？',
    sceneContextJa: '疲れや負担が残っている場面を思い浮かべてください。',
    choices: [
      { answerId: 'paid.recovery_sequence.pause_first', labelJa: 'いったん止めて休む' },
      { answerId: 'paid.recovery_sequence.small_start', labelJa: '小さく始め直す' },
      { answerId: 'paid.recovery_sequence.sort_materials', labelJa: '材料を整理してから戻る' },
    ],
  },
  {
    questionId: 'paid.restart_condition',
    shortLabelJa: '再開の条件',
    questionJa: '次の一手が出やすくなるのは、どれに近いですか？',
    sceneContextJa: '動き出しにくい場面を思い浮かべてください。',
    choices: [
      { answerId: 'paid.restart_condition.overview_first', labelJa: '全体の見通しが見える' },
      { answerId: 'paid.restart_condition.shrink_scope', labelJa: '範囲を小さくできる' },
      { answerId: 'paid.restart_condition.trusted_support', labelJa: '信頼できる人と話せる' },
    ],
  },
] as const;
