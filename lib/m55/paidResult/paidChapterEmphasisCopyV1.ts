...
> = {
  paid_ch1__baseline_landscape:
    '生年月日から置かれる暦の土台は、日々の気分では入れ替わりません。冒頭では、その土台を先に置き、あとから重ねる今の出方の意味がぶれないようにします。',
  paid_ch1__expression_mirror:
    'いま表に出ている動き方は、無料の5つの回答から読みます。プレミアムの6問は、そのあとで重点的に読むところを合わせます。',
  paid_ch1__align_diverge_bridge:
    '重なる点は、暦の土台と今の出方が同じ方向を向いている場面です。ずれる点は、無理がかかっている場面の手がかりとして扱います。どちらか一方だけを正解とはしません。',
...
> = {
  paid_ch1__baseline_landscape:
    '生年月日から置かれる暦の土台は、比較的変わりにくい出発点として、冒頭に置きます。',
  paid_ch1__expression_mirror:
    'いま表に出ている動き方は、無料の5つの回答から読みます。',
  paid_ch1__align_diverge_bridge:
    '暦の土台と、無料の回答に表れた今の出方が重なる点と、少しずれる点を分けて示します。',
  paid_ch2__start_rhythm:
