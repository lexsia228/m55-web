...
export const HOME_FREE_PREVIEW_FIXTURE = {
  ...
  headlineJa:
    '普段は間を取っているのに、会話の中では距離を言葉にしてしまう。丁寧に見える一方、あとから「近づきすぎた」が残る。普段は間を取っている相手に、会話の途中で距離を言葉にする。小さく直して見えても、本人はやり直すつもりで動かしている。周りには、場の流れを読んでから動く人に見える。返信を翌朝まで置いた朝に、同じ動きが出る。',
  sceneLabelJa: '人との距離',
  sceneBodyJa:
