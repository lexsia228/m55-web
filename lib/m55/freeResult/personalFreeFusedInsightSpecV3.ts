...
> = {
  ...
  wait: {
    ...
    wait: '土台の決め方も今回の答えも、間を置いてから閉じる側に重なっています。同じ方向に重なると、動いているように見えてもまだ決め切れていない時間が長い。',
  },
};
...
> = {
  ...
  middle: {
    close: '土台では一定の間隔を保ちやすいのに、今回の答えでは関わりの中で近さを言葉にして伝える側に寄っています。近い関係を丁寧に保っているように見えて、内側では間隔を一定にしたい感覚が残る。',
  ...
  solo: {
    close: '土台では一人の時間で整えてから戻りやすいのに、今回の答えでは関わりの中で近さを言葉にして伝える側に寄っています。近い関係を保っているように見えて、内側では一人で点検し直す時間が先に立ちやすい。',
