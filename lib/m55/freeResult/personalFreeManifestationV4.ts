...
const ABSTRACT_MODEL_LANGUAGE =
  /距離を整え|一定の間隔|接点の入口|基調の寄り|土台では|内側では|土台の接点|基調の速さ|置くつもりが|材料が足りなくて|輪郭を掴|比較表|あわせて、/;
...
> = {
  sort: {
    ...
    wait: {
      shortJa: '並べたあとも返事は翌朝',
      manifestationJa:
        '候補は並べ終わっているのに、返事は翌朝まで持っていく。決めた人に見られても、頭の中ではまだ比べが残っている。',
  ...
  wait: {
    sort: {
      ...
      manifestationJa:
        'いったん寝かせるつもりだったのに、夜には候補をまた開いている。待っている人に見られても、頭の中ではまだ並べ直している。',
      beatJa: '寝かせるつもりだった夜に、候補をまた開いている。',
      sceneWhen: 'まだ期限のない夜、候補をまた開き直すとき',
      sceneWhile: '寝かせるつもりが、夜には候補をまた開く',
    },
    deadline: {
      shortJa: '寝かせるつもりが期限で閉じてしまう',
      manifestationJa:
        '寝かせるつもりだったのに、期限の合図で閉じてしまう。締めた人に見られても、決めたあとに「もう一晩欲しかった」が残る。',
      beatJa: '寝かせるつもりが、期限の合図で閉じてしまう。',
      sceneWhen: '寝かせておきたかった案件を、期限の合図で閉じるとき',
...
> = {
  ...
  shrink: {
    ...
    scene: {
      ...
      manifestationJa:
        '席を変えている人に見られやすい。実際に欲しいのは、抱えている件数を落とすことだ。カフェに移っても、同じ仕事の束がそのまま残っている。',
      beatJa: '席を変えても、先に落としたいのは仕事の束である。',
      sceneWhen: '疲れた日に席を変えても、同じ仕事の束が残るとき',
