...
> = {
  ...
  R2: {
    T1: {
      ...
      action: '近づき方の違いが、同じやり取りの受け止め方を分けます。',
    },
    T2: {
      situation: '言葉の置き方がずれてきた場面で、安心の取り方の違いが見えやすいとき',
      action: '安心できる順序の違いが、言葉の受け止め方を分けます。',
    },
    T3: {
      situation: 'やり取りの速さがずれて見える場面',
      action: '返事の速さだけを見ると、会話の温度を取り違えやすくなります。',
    },
    T4: {
  ...
  R3: {
    T1: {
      ...
      action: '近づき方の違いが、話し合いを始めるタイミングに表れます。',
    },
    T2: {
    ...
    T3: {
      ...
      action: '決める速さの違いが、置いていかれた感覚につながりやすいです。',
    },
    T4: {
  ...
  R4: {
    T1: {
      ...
      action: '同じ静けさでも、必要な間合いか遠ざかった合図かで受け止めが分かれます。',
    },
    T2: {
      situation: '距離がある中で、受け止め方の順序がずれて見える場面',
      action: '受け止める順序の違いが、沈黙の意味を一つに決めやすくします。',
    },
    T3: {
  ...
  R5: {
    T1: {
      ...
      action: '以前の近さを基準にすると、今置ける小さな接点を見失いやすくなります。',
    },
    T2: {
      situation: '以前は近かったがいま離れている状態では、受け止め方の順序がずれて見えるとき',
      action: '過去を整理する順序の違いが、再接近のタイミングを分けます。',
    },
    T3: {
  ...
  R6: {
    T1: {
      ...
      action: '日常の声のかけ方の違いが、小さな判断の積み重なりに表れます。',
    },
    T2: {
      situation: '日常の中で、受け止め方の順序がずれて見える場面',
      action: '安心を確かめる順序の違いが、いつもの会話の終わり方を分けます。',
    },
    T3: {
