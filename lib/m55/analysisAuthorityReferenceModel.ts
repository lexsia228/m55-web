...
export const M55_USER_FACING_POSITIONING_COPY = [
  'M55は、生年月日から得る手がかりと、選択式の質問による現在の感じ方を商品ごとの固定ルールで組み合わせ、自分や二人の関係を整理する読み解きサービスです。',
  '個人の読み解きでは日本の暦文化上の手がかりを段階に応じて扱い、二人の読み解きでは二人分の日付から得る比較用の手がかりと現在の回答を扱います。',
...
export const M55_PUBLIC_COMMERCIAL_TRUTH = {
  summaryJa:
    'M55は、生年月日から得る手がかりと選択式の質問を商品ごとの固定ルールで組み合わせ、考え方・動き方・二人の反応の違いを整理する読み解きシステムです。',
  inputs: {
    personalJa: [
      '本人の生年月日',
      '現在の表れ方を確認する5つの傾向質問',
    ...
    compatibilityJa: [
      '二人分の生年月日',
      '入力者から観察できる距離・会話などの5問',
      '今、確かめたい関係の焦点1問（合計6回答）',
    ] as const,
  },
  processing: {
    frameworkJa:
    ...
    personalFreeJa:
      '個人の無料見取り図は、生年月日から得る無料用の暦の手がかりと、5つの傾向質問・今の関心1問を固定ルールで組み合わせます。有料保存版の詳細な暦処理は行わず、生成AIも使用しません。',
    personalSavedJa:
      '個人の保存版は、無料6回答に購入前の追加6回答と、より詳細な暦の手がかりを重ね、固定ルールと検査済みの文章素材を土台に4章で組み立てます。提供設定に応じて章の文章表現に生成AIを使う場合がありますが、品質条件を満たさない場合は固定ルールの本文へ戻します。',
    personalAdditionalJa:
      '追加読み解きは、購入済み保存版と選んだ1テーマを土台に生成AIで文章を組み立てます。汎用チャットではなく、利用可能件数の範囲で1テーマずつ扱います。',
    compatibilityFreeJa:
      '二人の無料見取り図は、二人分の日付から得る比較用の手がかりと、現在の距離・会話・焦点を含む合計6回答を固定ルールで組み合わせます。個人保存版の旧暦処理は適用せず、生成AIも使用しません。',
    compatibilitySavedJa:
      '二人の保存版は、無料結果と同じ二人分の日付・合計6回答を固定ルールで6章に展開します。個人保存版の暦処理や生成AIは使用せず、購入したアカウントへ保存します。',
  },
  outputs: {
    personalFreeJa:
