...
export const TOP_FREE_ENTRY_PUBLIC_COPY = {
  ...
  howM55Works: {
    metadataDescriptionJa:
      'M55の3つの入口（無料で見る・複合解析・追加解析）と、見取り図・保存版・相談返書の関係を静かに説明します。',
    threeTierSectionTitleJa: 'M55の3つの入口',
    threeTierIntroJa:
      'M55には、3つの入口があります。それぞれの中身を、下で順に説明します。',
    threeTierItemsJa: [
      {
        titleJa: '無料で見る',
        subLabelJa: '無料の見取り図',
        descJa:
          '自分の入口・輪郭を、10資質レーンと5つの視点で、無料の見取り図として確認します。',
      },
      {
        titleJa: '複合解析',
        subLabelJa: '保存版',
        descJa:
          'M55複合暦解析として、生年月日の暦リズムまで重ね、自分を深く読み解きます。購入後は4章の保存版として手元に残ります。',
      },
      {
        titleJa: '追加解析',
        subLabelJa: '相談返書',
        descJa:
          'M55追加解析として、保存版を土台に、いまの1テーマをさらに具体化します。具体機能は相談返書です。',
      },
    ] as const,
    receiveFreeLeadJa:
      '「無料で見る」では、10資質レーンと5つの視点で、無料の見取り図として自分の輪郭を確認できます。',
    receiveFreeExperienceJa:
      '本質ポスター、傾向の輪郭、M55の読み方、傾向と負荷、このタイプはどう出やすいか、まず整えるとよいこと、観測までを通して、今の自分がどう出やすいかをつかんでいきます。',
    receiveFreeClosingJa:
      'ここで渡すのは、すべての答えではなく、まず見取り図です。',
    receiveSavedLeadJa:
      '「複合解析（M55複合暦解析）」では、生年月日の暦リズムまで重ねて、自分を深く読み解きます。購入後は4章の保存版として、動き方・疲れ方・戻し方を固定ルールで読み返せる形に整理します。',
    receiveContrastJa: '無料が輪郭なら、4章の保存版は構造と戻し方です。',
    receiveConsultJa:
      '「追加解析（M55追加解析）」では、保存版を土台に、いまの1テーマをさらに具体化します。具体機能は相談返書で、保存版に紐づく一つの相談テーマへの返書です。会話を続ける形式ではありません。',
    receiveConsultDetailLeadJa:
      '見えている傾向を前提に、人間関係、疲れやすさ、動き方の迷いなどを、その人の流れに沿って整理し直せます。',
    receiveConsultDetailClosingJa:
      'その場の入力だけを広げるのではなく、すでに見えている傾向や組み合わせを踏まえて、今のテーマを読み直していきます。',
    commercialFlowKickerJa: '無料で見る → 複合解析 → 追加解析',
    operationalFlowKickerJa: '無料の見取り図 → 保存版 → 相談返書',
    flowLayerBridgeJa:
      '上の3つの入口は、下の読み物の名前とこう対応します。',
    flowNoteJa:
      '相談返書は独立した商品ではなく、保存版に付随する返書です。',
    boundaryJa:
      'M55は、吉凶で決めつけたり、未来を当てるものではありません。医療・法律・投資などの専門助言に代わるものでもありません。自分を見つめ直すための、読み返せる見取り図です。',
    frameworkSavedJa: '4章の保存版まで同じになるわけではありません。',
    nextLeadJa:
      'まずは、無料で見る。無料の見取り図で、自分の輪郭を確認してみてください。',
    nextSubJa:
      'さらに深く読むときは、複合解析（保存版）のプランを。追加解析は、保存版を読んだあとに相談返書で、いまのテーマを読み直せます。',
