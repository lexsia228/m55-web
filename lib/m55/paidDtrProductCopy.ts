...
export const PAID_DTR_CONSULT_ENTRY_LAYOUT = {
  ...
  fixedReportBulletsJa: [
    '購入時の入力を土台にしたプレミアムレポートを、あとから読み返せます。表示の言い回しは、現在の製品表記に合わせて整うことがあります',
...
export const PAID_DTR_PRICING_AUTHORITY_NOTE_JA =
  'M55のプレミアムレポートは、生年月日から得られる日本の暦文化上の手がかりと、本人の回答による現在の感じ方を重ね、6問の回答で重点的に読むところを合わせ、自己理解と関係性整理に使える形へ整える参考情報です。' as const;
...
export const PAID_DTR_LP = {
  ...
  hero: {
    subheadlineJa:
      '生年月日の暦の土台と、無料で見えた今の出方を重ね、深く読むところを合わせるデジタルレポートです。',
    headlineJa: 'M55 プレミアムレポート',
    bodyJa:
      '自分に出やすい傾向、力が出やすい条件、\n無理の出方、日常での扱い方までを、\n一つの流れで読めます。\n\n購入後は、購入時の入力を土台にしたレポートを開き直せます。\n気になったテーマは、追加読み解きで整理できます。',
    ctaLabelJa: 'プラン選択へ進む',
  ...
  freeComparison: {
    ...
    bodyJa:
      '無料ページは、生年月日の暦の土台と、いまの出方の入口です。\nプレミアムレポートでは、その上で重点的に読むところまで一つの流れで整理します。',
  },
  chapters: {
  ...
  purchaseNotes: {
    ...
    paragraphsJa: [
      ...
      '購入時の入力は保持されます。あとからプロフィールを変えても、その購入入力が自動で置き換わることはありません。',
  ...
  purchaseTrustRetrieval: {
    ...
    items: [
      ...
      },
      {
        ...
        answerJa:
          '無料の見取り図で、生年月日とニックネーム、いまの回答から自分に出やすい輪郭の入口を確認できます。公開の無料入口は、ログイン不要で始められます。',
      ...
      },
      {
        ...
        answerJa:
          '生年月日や回答情報は、読み取りの生成とサービス提供のため、プライバシーポリシーに掲載の目的の範囲で取り扱います。公開の自分用では、いまは生年月日までを使い、出生の時刻や場所は使いません。決済の確認に必要な取引情報は取得し、決済の処理は外部の決済事業者を利用します。情報の種類・利用目的・委託の詳細はプライバシーポリシーをご確認ください。',
      ...
      },
      {
        ...
        answerJa:
          '決済完了後、ウェブ上でプレミアムレポートを閲覧できます。物理配送はありません。購入したレポートは、購入時の入力を土台に読み返せます。',
        links: [{ labelJa: '特定商取引法に基づく表記', href: '/legal/tokushoho' }],
      },
    ] as const,
  },
