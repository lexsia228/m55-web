...
export const PAID_DTR_DEEP_READING_TAKEAWAYS: Record<PaidDtrReportPartId, PaidDtrDeepReadingTakeaway> = {
  ...
  '2': {
    ...
    itemsJa: [
      '力が出やすいとき: 先に整える場所が見え、ひとつずつ進められるとき。',
      '止まりやすいとき: 同時に多くを求められたり、急かされて優先が見えなくなるとき。',
      'まず意識すること: 今日の優先を一つに絞ると、動き出す場所が見えやすくなります。',
  ...
  '3': {
    ...
    itemsJa: [
      '力が出やすいとき: 大切な人と、落ち着いて言葉と距離を置けるとき。',
      '止まりやすいとき: 分かってほしい気持ちが強くなり、相手の反応を抱え込みすぎるとき。',
