...
export const PAID_DTR_FREE_VS_PAID = {
  ...
  freeGives: [
    '生年月日から得る無料用の手がかりと、5つの傾向質問・今の関心1問から、現在の輪郭を読む入口',
    '5つの視点と今の関心から、最初に確かめる行動まで整理',
    '保存版へ進む前に、自分の読み方の土台をつかむ',
  ] as const,
  paidAdds: [
    '無料6回答に購入前の追加6回答と、より詳細な暦の手がかりを重ねた4章',
...
export const PAID_DTR_LP = {
  ...
  purchaseNotes: {
    ...
    paragraphsJa: [
      '保存版は、購入時点の生年月日・プロフィール・質問回答をもとにした4章の読み物です。未来予測や吉凶の断定ではありません。',
